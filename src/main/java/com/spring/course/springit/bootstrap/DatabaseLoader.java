package com.spring.course.springit.bootstrap;
...
import com.spring.course.springit.repository.RoleRepository;
...
public class DatabaseLoader implements CommandLineRunner {
	...
	private void addUsersAndRoles() {
		...
		User user = new User("user@gmail.com", secret, true, "Max", "User", "TheUser");
		user.addRole(userRole);
		user.setConfirmPassword(secret);
		userRepository.save(user);
		users.put("user@gmail.com",user);

		User admin = new User("admin@gmail.com", secret, true, "Max", "Admin", "TheAdmin");
		admin.addRole(adminRole);
		admin.setConfirmPassword(secret);
		userRepository.save(admin);
		users.put("admin@gmail.com",admin);

		User master = new User("super@gmail.com", secret, true, "Max","Master", "Mastermind");
